...
typedef FoldingRangeServerCapabilities = {
    ...
    **/
    var ?foldingRangeProvider:EitherType<Bool,EitherType<FoldingRangeProviderOptions,FoldingRangeProviderOptions & TextDocumentRegistrationOptions & StaticRegistrationOptions>>;
}
