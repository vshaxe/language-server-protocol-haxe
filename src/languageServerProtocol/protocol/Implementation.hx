...
class ImplementationMethods {
    /**
        ...
        document position.
    **/
    static inline var Implementation = new RequestMethod<TextDocumentPositionParams,Null<Definition>,NoData,TextDocumentRegistrationOptions>("textDocument/implementation");
}
