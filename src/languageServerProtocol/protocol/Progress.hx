...
class WorkDoneProgressCreateRequest {
	public static inline final type = new ProtocolRequestType<WorkDoneProgressCreateParams, NoData, Never, NoData, NoData>("window/workDoneProgress/create");
}
...
class WorkDoneProgressCancelNotification {
	public static inline final type = new ProtocolNotificationType<WorkDoneProgressCancelParams, NoData>("window/workDoneProgress/cancel");
}
