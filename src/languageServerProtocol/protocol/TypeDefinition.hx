...
class TypeDefinitionMethods {
    /**
        ...
        document position.
    **/
    static inline var TypeDefinition = new RequestMethod<TextDocumentPositionParams,Null<Definition>,NoData,TextDocumentRegistrationOptions>("textDocument/typeDefinition");
}
